...
- **Версия**: 1.21.10 (или версия, указанная в `MINECRAFT_VERSION`)

**Примечание:** Сервер использует библиотеку `flying-squid` версии 1.11.0 для создания полноценного Minecraft сервера с поддержкой игрового мира, блоков и сущностей.
