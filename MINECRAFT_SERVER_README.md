...
**Примечание:** Сервер использует библиотеку `flying-squid` для создания полноценного Minecraft сервера с поддержкой игрового мира, блоков и сущностей.
...
- Сервер использует библиотеку **`flying-squid`** для создания полноценного Minecraft сервера
