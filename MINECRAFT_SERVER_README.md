...
**Примечание:** Сервер использует библиотеку `prismarine-server` для создания полноценного Minecraft сервера с поддержкой игрового мира, блоков и сущностей.
...
- Сервер использует библиотеку **`prismarine-server`** для создания полноценного Minecraft сервера
