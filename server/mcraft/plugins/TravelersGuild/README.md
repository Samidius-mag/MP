...
**Примечание:** Плагин использует встроенную систему отображения через Armor Stand для многострочного текста над головой игроков. Дополнительные плагины не требуются.
